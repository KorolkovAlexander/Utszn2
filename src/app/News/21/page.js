...
export default function Page() {
    return (
      ...
      <div className={styles.title2}>Ровеньчанке вручено удостоверение российского образца – члену семьи погибшего (умершего) участника Великой Отечественной войны</div>
...
Согласно данного Порядка, Поповой Елене Илларионовне вручено удостоверение российского образца, как члену семьи умершего участника Великой Отечественной войны.
Удостоверение является бессрочным и действует на всей территории Российской Федерации.
