...
export default function Page() {
    return (
      ...
      <div className={styles.text2}> 10.07.2025 состоялся выездной прием граждан представителями Филиала № 14 ГКУ ЛНР «Республиканский центр социальной защиты населения» в г. Ровеньки в отделе жизнеобеспечения 
...
На приёме даны разъяснения 21 жителям пгт. Пролетарский по вопросу оказания меры социальной поддержки (в денежном выражении) для приобретения твердого бытового топлива (угля).
