...
export default function Page() {
  ...
  return (
    ...
    <Post title={"О ПРЕДОСТАВЛЕНИИ МЕРЫ СОЦИАЛЬНОЙ ПОДДЕРЖКИ (В ДЕНЕЖНОМ ВЫРАЖЕНИИ) ДЛЯ ПРИОБРЕТЕНИЯ ТВЕРДОГО БЫТОВОГО ТОПЛИВА (УГЛЯ) ГРАЖДАНАМ ОТДЕЛЬНЫХ КАТЕГОРИЙ, ПРОЖИВАЮЩИМ НА ТЕРРИТОРИИЛУГАНСКОЙ НАРОДНОЙ РЕСПУБЛИКИ (на отопительный сезон 2024-2025 гг)"}  src={"/60.jpg"} l={"/Pay/11"}/>
    <Post title={"Меры социальной поддержки многодетным семьям на территории Луганской Народной Республики"}  src={"/72.jpg"} l={"Pay/12"}/>
    <Post title={"Филиал № 14 Государственного казенного учреждения Луганской Народной Республики «Республиканский центр социальной защиты населения» в городе Ровеньки  предоставляет ежемесячную денежную выплату  на оплату проезда в пассажирском транспорте общего пользования (кроме такси)"}  src={"/104.jpg"} l={"Pay/13"}/>
      </main>
