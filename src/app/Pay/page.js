...
export default function Page() {
  ...
  return (
    ...
    <Post title={"О выплате ко Дню Победы в Великой Отечественной войне 1941-1945 годов "}  src={"/33.jpg"} l={"Pay/9"}/>
    <Post title={"Порядок замены удостоверений, выданных до 01 марта 2023 года, на удостоверения ветерана Великой Отечественной войны"}  src={"/41.jpg"} l={"/Pay/10"}/>
